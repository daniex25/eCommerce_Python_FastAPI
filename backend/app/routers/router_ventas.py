...
@router.get("/clientes/{codigo}", response_model=ClienteResponse, tags=["Clientes"])
...
@router.post("/clientes", response_model=ClienteResponse, status_code=status.HTTP_201_CREATED, tags=["Clientes"])
...
@router.put("/clientes/{codigo}", response_model=ClienteResponse, tags=["Clientes"])
...
@router.delete("/clientes/{codigo}", status_code=status.HTTP_204_NO_CONTENT, tags=["Clientes"])
...
# ── Carritos ───────────────────────────────────────────────────────────────
@router.get("/carritos", response_model=List[CarritoResponse], tags=["Carritos"])
def listar_carritos(db: Session = Depends(get_db)):
    return db.query(CarritodeCompras).all()


@router.get("/carritos/{codigo}", response_model=CarritoResponse, tags=["Carritos"])
...
@router.post("/carritos", response_model=CarritoResponse, status_code=status.HTTP_201_CREATED, tags=["Carritos"])
...
@router.put("/carritos/{codigo}", response_model=CarritoResponse, tags=["Carritos"])
...
@router.delete("/carritos/{codigo}", status_code=status.HTTP_204_NO_CONTENT, tags=["Carritos"])
...
@router.get("/pedidos/{numero}", response_model=PedidoResponse, tags=["Pedidos"])
...
@router.post("/pedidos", response_model=PedidoResponse, status_code=status.HTTP_201_CREATED, tags=["Pedidos"])
...
@router.put("/pedidos/{numero}", response_model=PedidoResponse, tags=["Pedidos"])
...
@router.delete("/pedidos/{numero}", status_code=status.HTTP_204_NO_CONTENT, tags=["Pedidos"])
...
# ── DetallePedido ──────────────────────────────────────────────────────────
@router.get("/detalle-pedidos", response_model=List[DetallePedidoResponse], tags=["Detalle Pedidos"])
def listar_detalle_pedidos(db: Session = Depends(get_db)):
    return db.query(DetallePedido).all()


@router.get("/detalle-pedidos/{id}", response_model=DetallePedidoResponse, tags=["Detalle Pedidos"])
...
@router.post("/detalle-pedidos", response_model=DetallePedidoResponse, status_code=status.HTTP_201_CREATED, tags=["Detalle Pedidos"])
...
@router.put("/detalle-pedidos/{id}", response_model=DetallePedidoResponse, tags=["Detalle Pedidos"])
...
@router.delete("/detalle-pedidos/{id}", status_code=status.HTTP_204_NO_CONTENT, tags=["Detalle Pedidos"])
...
# ── Recetas Medicas ────────────────────────────────────────────────────────
@router.get("/recetas-medicas", response_model=List[RecetaResponse], tags=["Recetas Medicas"])
def listar_recetas(db: Session = Depends(get_db)):
    return db.query(RecetaMedica).all()


@router.get("/recetas-medicas/{numero}", response_model=RecetaResponse, tags=["Recetas Medicas"])
...
@router.post("/recetas-medicas", response_model=RecetaResponse, status_code=status.HTTP_201_CREATED, tags=["Recetas Medicas"])
...
@router.put("/recetas-medicas/{numero}", response_model=RecetaResponse, tags=["Recetas Medicas"])
...
@router.delete("/recetas-medicas/{numero}", status_code=status.HTTP_204_NO_CONTENT, tags=["Recetas Medicas"])
...
@router.get("/repartidores/{codigo}", response_model=RepartidorResponse, tags=["Repartidores"])
...
@router.post("/repartidores", response_model=RepartidorResponse, status_code=status.HTTP_201_CREATED, tags=["Repartidores"])
...
@router.put("/repartidores/{codigo}", response_model=RepartidorResponse, tags=["Repartidores"])
...
@router.delete("/repartidores/{codigo}", status_code=status.HTTP_204_NO_CONTENT, tags=["Repartidores"])
...
# ── Entregas ───────────────────────────────────────────────────────────────
@router.get("/entregas", response_model=List[EntregaResponse], tags=["Entregas"])
def listar_entregas(db: Session = Depends(get_db)):
    return db.query(Entrega).all()


@router.get("/entregas/{codigo}", response_model=EntregaResponse, tags=["Entregas"])
...
@router.post("/entregas", response_model=EntregaResponse, status_code=status.HTTP_201_CREATED, tags=["Entregas"])
...
@router.put("/entregas/{codigo}", response_model=EntregaResponse, tags=["Entregas"])
...
@router.delete("/entregas/{codigo}", status_code=status.HTTP_204_NO_CONTENT, tags=["Entregas"])
...
# ── Pagos ──────────────────────────────────────────────────────────────────
@router.get("/pagos", response_model=List[PagoResponse], tags=["Pagos"])
def listar_pagos(db: Session = Depends(get_db)):
    return db.query(Pago).all()


@router.get("/pagos/{codigo}", response_model=PagoResponse, tags=["Pagos"])
...
@router.put("/pagos/{codigo}", response_model=PagoResponse, tags=["Pagos"])
...
@router.delete("/pagos/{codigo}", status_code=status.HTTP_204_NO_CONTENT, tags=["Pagos"])
...
# ── Comprobantes ───────────────────────────────────────────────────────────
@router.get("/comprobantes", response_model=List[ComprobanteResponse], tags=["Comprobantes"])
def listar_comprobantes(db: Session = Depends(get_db)):
    return db.query(Comprobante).all()


@router.get("/comprobantes/{numero}", response_model=ComprobanteResponse, tags=["Comprobantes"])
...
@router.post("/comprobantes", response_model=ComprobanteResponse, status_code=status.HTTP_201_CREATED, tags=["Comprobantes"])
...
@router.put("/comprobantes/{numero}", response_model=ComprobanteResponse, tags=["Comprobantes"])
...
@router.delete("/comprobantes/{numero}", status_code=status.HTTP_204_NO_CONTENT, tags=["Comprobantes"])
