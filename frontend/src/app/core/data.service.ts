...
export class DataService {
  ...
  private productos: Producto[] = [
    { codigoProducto: 1, codigoCategoria: 1, codigoLaboratorio: 4, nombreProducto: 'Paracetamol 500mg', descripcion: 'Analgésico y antipirético. Caja x 100 tabletas.', precioVenta: 8.50, condicionVenta: 'Venta Libre', stockDisponible: 320, categoria: 'Medicamentos', laboratorio: 'Medifarma', presentacion: 'Caja x 100 tab', stockMinimo: 50, icono: 'fa-pills' },
    { codigoProducto: 2, codigoCategoria: 1, codigoLaboratorio: 1, nombreProducto: 'Aspirina 100mg', descripcion: 'Ácido acetilsalicílico. Prevención cardiovascular.', precioVenta: 12.90, condicionVenta: 'Venta Libre', stockDisponible: 145, categoria: 'Medicamentos', laboratorio: 'Bayer', presentacion: 'Caja x 30 tab', stockMinimo: 40, icono: 'fa-pills' },
    { codigoProducto: 3, codigoCategoria: 1, codigoLaboratorio: 3, nombreProducto: 'Amoxicilina 500mg', descripcion: 'Antibiótico de amplio espectro.', precioVenta: 18.00, condicionVenta: 'Bajo Receta', stockDisponible: 0, categoria: 'Medicamentos', laboratorio: 'Genfar', presentacion: 'Caja x 21 cáps', stockMinimo: 30, icono: 'fa-pills' },
    { codigoProducto: 4, codigoCategoria: 1, codigoLaboratorio: 2, nombreProducto: 'Azitromicina 500mg', descripcion: 'Antibiótico macrólido.', precioVenta: 24.50, condicionVenta: 'Bajo Receta', stockDisponible: 62, categoria: 'Medicamentos', laboratorio: 'Pfizer', presentacion: 'Caja x 3 tab', stockMinimo: 25, icono: 'fa-pills' },
    { codigoProducto: 5, codigoCategoria: 1, codigoLaboratorio: 6, nombreProducto: 'Ibuprofeno 400mg', descripcion: 'Antiinflamatorio no esteroideo.', precioVenta: 9.90, condicionVenta: 'Venta Libre', stockDisponible: 210, categoria: 'Medicamentos', laboratorio: 'Hersil', presentacion: 'Caja x 100 tab', stockMinimo: 50, icono: 'fa-pills' },
    { codigoProducto: 6, codigoCategoria: 2, codigoLaboratorio: 8, nombreProducto: 'Termómetro Digital', descripcion: 'Medición rápida y precisa. Punta flexible.', precioVenta: 25.90, condicionVenta: 'Venta Libre', stockDisponible: 48, categoria: 'Dispositivos Médicos', laboratorio: 'Abbott', presentacion: 'Unidad', stockMinimo: 15, icono: 'fa-thermometer' },
    { codigoProducto: 7, codigoCategoria: 2, codigoLaboratorio: 8, nombreProducto: 'Tensiómetro Digital de Brazo', descripcion: 'Monitor de presión arterial automático.', precioVenta: 129.00, condicionVenta: 'Venta Libre', stockDisponible: 12, categoria: 'Dispositivos Médicos', laboratorio: 'Abbott', presentacion: 'Unidad', stockMinimo: 5, icono: 'fa-stethoscope' },
    { codigoProducto: 8, codigoCategoria: 2, codigoLaboratorio: 8, nombreProducto: 'Glucómetro Accu-Chek', descripcion: 'Medidor de glucosa en sangre con 10 tiras.', precioVenta: 89.90, condicionVenta: 'Venta Libre', stockDisponible: 9, categoria: 'Dispositivos Médicos', laboratorio: 'Roche', presentacion: 'Kit', stockMinimo: 8, icono: 'fa-droplet' },
    { codigoProducto: 9, codigoCategoria: 3, codigoLaboratorio: 7, nombreProducto: 'Protector Solar FPS 50+', descripcion: 'Anthelios. Protección alta para rostro.', precioVenta: 68.00, condicionVenta: 'Venta Libre', stockDisponible: 35, categoria: 'Dermocosmética', laboratorio: 'La Roche-Posay', presentacion: 'Frasco 50ml', stockMinimo: 10, icono: 'fa-pump-soap' },
    { codigoProducto: 10, codigoCategoria: 3, codigoLaboratorio: 7, nombreProducto: 'Gel Limpiador Facial', descripcion: 'Effaclar. Piel grasa y con tendencia acneica.', precioVenta: 54.50, condicionVenta: 'Venta Libre', stockDisponible: 28, categoria: 'Dermocosmética', laboratorio: 'La Roche-Posay', presentacion: 'Frasco 200ml', stockMinimo: 10, icono: 'fa-pump-soap' },
    { codigoProducto: 11, codigoCategoria: 4, codigoLaboratorio: 4, nombreProducto: 'Pañales Etapa 3 x40', descripcion: 'Hipoalergénicos, 6 a 10 kg.', precioVenta: 42.90, condicionVenta: 'Venta Libre', stockDisponible: 60, categoria: 'Infantil', laboratorio: 'Medifarma', presentacion: 'Paquete x 40', stockMinimo: 20, icono: 'fa-baby' },
    { codigoProducto: 12, codigoCategoria: 4, codigoLaboratorio: 6, nombreProducto: 'Suero Fisiológico Bebé', descripcion: 'Solución para higiene nasal infantil.', precioVenta: 14.50, condicionVenta: 'Venta Libre', stockDisponible: 90, categoria: 'Infantil', laboratorio: 'Hersil', presentacion: 'Caja x 20 amp', stockMinimo: 25, icono: 'fa-baby' },
    { codigoProducto: 13, codigoCategoria: 5, codigoLaboratorio: 2, nombreProducto: 'Vitamina C 1000mg', descripcion: 'Refuerzo del sistema inmune. Efervescente.', precioVenta: 29.90, condicionVenta: 'Venta Libre', stockDisponible: 110, categoria: 'Vitaminas y Suplementos', laboratorio: 'Pfizer', presentacion: 'Tubo x 20 tab', stockMinimo: 30, icono: 'fa-capsules' },
    { codigoProducto: 14, codigoCategoria: 5, codigoLaboratorio: 5, nombreProducto: 'Vitamina D3 2000 UI', descripcion: 'Salud ósea e inmunológica.', precioVenta: 38.50, condicionVenta: 'Venta Libre', stockDisponible: 24, categoria: 'Vitaminas y Suplementos', laboratorio: 'Roche', presentacion: 'Frasco x 60 cáps', stockMinimo: 15, icono: 'fa-capsules' },
    { codigoProducto: 15, codigoCategoria: 5, codigoLaboratorio: 6, nombreProducto: 'Colágeno Hidrolizado', descripcion: 'Con magnesio y vitamina C. Sabor frutos rojos.', precioVenta: 75.00, condicionVenta: 'Venta Libre', stockDisponible: 18, categoria: 'Vitaminas y Suplementos', laboratorio: 'Hersil', presentacion: 'Pote 300g', stockMinimo: 10, icono: 'fa-capsules' },
    { codigoProducto: 16, codigoCategoria: 6, codigoLaboratorio: 4, nombreProducto: 'Alcohol en Gel 1L', descripcion: 'Antibacterial 70°. Dispensador.', precioVenta: 16.90, condicionVenta: 'Venta Libre', stockDisponible: 140, categoria: 'Bioseguridad e Higiene', laboratorio: 'Medifarma', presentacion: 'Botella 1L', stockMinimo: 40, icono: 'fa-hand-sparkles' },
    { codigoProducto: 17, codigoCategoria: 6, codigoLaboratorio: 4, nombreProducto: 'Mascarillas KN95 x10', descripcion: 'Protección respiratoria, 5 capas.', precioVenta: 19.90, condicionVenta: 'Venta Libre', stockDisponible: 4, categoria: 'Bioseguridad e Higiene', laboratorio: 'Medifarma', presentacion: 'Caja x 10', stockMinimo: 30, icono: 'fa-mask-face' },
    { codigoProducto: 18, codigoCategoria: 1, codigoLaboratorio: 3, nombreProducto: 'Loratadina 10mg', descripcion: 'Antihistamínico para alergias.', precioVenta: 7.50, condicionVenta: 'Venta Libre', stockDisponible: 175, categoria: 'Medicamentos', laboratorio: 'Genfar', presentacion: 'Caja x 10 tab', stockMinimo: 40, icono: 'fa-pills' },
  ];
  private lotes: Lote[] = [
  ...
  private movimientosCaja: MovimientoCaja[] = [
  ...
  // ── Reportes (dashboard) ──
  private topVendidos: ProductoVendido[] = [
  ...
  private pedidosSignal = signal<Pedido[]>(this.pedidos);
  private lotesSignal = signal<Lote[]>(this.lotes);
  private clientesSignal = signal<Cliente[]>(this.clientes);
  private repartidoresSignal = signal<Repartidor[]>(this.repartidores);
  private entregasSignal = signal<Entrega[]>(this.entregas);
  private recetasSignal = signal<RecetaMedica[]>(this.recetas);
  private comprobantesSignal = signal<Comprobante[]>(this.comprobantes);
  private proveedoresSignal = signal<Proveedor[]>(this.proveedores);
  private ordenesSignal = signal<OrdenCompra[]>(this.ordenes);
  private reclamosSignal = signal<Reclamo[]>(this.reclamos);
  private cuponesSignal = signal<Cupon[]>(this.cupones);
  private movimientosSignal = signal<MovimientoCaja[]>(this.movimientosCaja);
  private topVendidosSignal = signal<ProductoVendido[]>(this.topVendidos);
  public ventasSemana = this.ventasSemanaMock;

  getCategorias() { return this.categoriasSignal(); }
  getProductos() { return this.productosSignal(); }
  getPedidos() { return this.pedidosSignal(); }
  getLotes() { return this.lotesSignal(); }
  getClientes() { return this.clientesSignal(); }
  getRepartidores() { return this.repartidoresSignal(); }
  getEntregas() { return this.entregasSignal(); }
  getRecetas() { return this.recetasSignal(); }
  getComprobantes() { return this.comprobantesSignal(); }
  getProveedores() { return this.proveedoresSignal(); }
  getOrdenes() { return this.ordenesSignal(); }
  getReclamos() { return this.reclamosSignal(); }
  getCupones() { return this.cuponesSignal(); }
  getMovimientos() { return this.movimientosSignal(); }
  getTopVendidos() { return this.topVendidosSignal(); }
  ...
  getProducto(id: number) {
    return this.productosSignal().find(p => p.codigoProducto === id);
  }
  ...
  // ── CONSTRUCTOR: CARGA DATOS DEL BACKEND SI ES NECESARIO ──
  constructor() {
